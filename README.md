...
- Google login/logout
- `Open` and `Started` filtering via the header filter's `Status` dropdown, with `Done` and `Deleted` available from the `...` menu
